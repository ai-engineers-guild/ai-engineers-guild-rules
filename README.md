...
We follow a two-branch strategy:
- **`master`**: The stable, "protected" branch containing the current agreed-upon rules and roadmap.
- **`dev`**: The playground. Submit your Pull Requests here for any new ideas, rule changes, or roadmap additions.
