...
Сообщество является самоуправляемым. Здесь нет слепого авторитаризма. Правила (`rules.md`) и дорожная карта (`backlog.md`) лежат в открытом репозитории. Любой участник может предложить изменение через Pull Request. Твой ранг и влияние определяются реальным вкладом (Proof of Work), а не красивыми должностями.
...
* **Физические встречи и спонтанный оффлайн:** Локальные митапы, совместный кодинг в коворкингах и традиция спонтанных посиделок (просто собраться потрындеть в баре или уютном лаунже без жесткой адженды). Если вы оказались в Алматы, просто напишите в чат — здесь всегда найдется компания для восхождения на пик или вечернего обсуждения системных промптов.
